...
// import profile from "../../public/BMW-Logo.png";
...
//         <div className="w-[100%] py-3 px-2  border rounded-l-full">
//           <input type="text" placeholder="search" className=" outline-none" />
//         </div>
//         <button className="px-4 py-2  items-center bg-gray-100 border-r-full">
//           <CiSearch size={"24px"} />
//         </button>
//         <IoMicSharp
//           size={"42px"}
